...
class DownloadableItemDetailsDialog(context: Context, var mItem: AndroidDownloadableItem) : AppCompatDialog(context) {
    ...
    private class ItemDetailsDialogParams(var mContext: Context) {

        var mOnItemDetailsListener: OnItemDetailsListener? = null

        fun apply(itemDetailsDialog: DownloadableItemDetailsDialog) {
