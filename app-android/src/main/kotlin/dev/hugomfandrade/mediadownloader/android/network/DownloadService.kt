...
import dev.hugomfandrade.mediadownloader.android.app.main.MainActivity
...
class DownloadService : Service() {
    ...
    private val downloadExecutors = Executors.newFixedThreadPool(Config.Companion.nDownloadThreads)
            ...
            override fun onDownloadStateChange(downloadableItem: DownloadableItem) {
                ...
                if (DownloadableItem.State.isOver(downloadableItem.state)) {
                    ...
                    if (downloadableItem.state == DownloadableItem.State.End) {
                        ...
                        if (filePath != null) {
                            MediaScannerConnection.scanFile(this@DownloadService, arrayOf(filePath), null, null)
                        }
                    }
