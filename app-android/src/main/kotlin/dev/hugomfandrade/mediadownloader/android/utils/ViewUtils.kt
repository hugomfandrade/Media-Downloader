...
import dev.hugomfandrade.mediadownloader.android.widget.ExpandCollapseAnimation
...
private constructor() {
    ...
    companion object {
        ...
        fun showToast(context: Context, text: String?, vararg args: Any) {
            ...
            if (DevConstants.Companion.showLog) Log.d(TAG, text)
            sLastToast = text
        }
        ...
        fun showToast(
            ...
            if (DevConstants.Companion.showLog) Log.d(TAG, context.resources.getString(id))
        ...
        fun findImageViewWithTransitionName(
            ...
            if (DevConstants.Companion.showLog)
                Log.w(TAG,
